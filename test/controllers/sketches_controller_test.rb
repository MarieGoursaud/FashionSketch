...
class SketchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sketch" do
    assert_difference('Sketch.count') do
      post sketches_url, params: { sketch: { date: @sketch.date, image: @sketch.image, name: @sketch.name, type: @sketch.type } }
    end
  ...
  test "should update sketch" do
    patch sketch_url(@sketch), params: { sketch: { date: @sketch.date, image: @sketch.image, name: @sketch.name, type: @sketch.type } }
